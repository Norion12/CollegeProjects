...
I think the keys to writing maintainable, readable and adaptable code are keeping the code clean and modular. Working on pieces and confirming the operation of the program helps you move forward with confidence that you are goin in the right direction. Not only does this make your code easier to read later on, it gives you confidence that you are making progress towards a final working product. Working at first in the shell let me confirm the working status of my CRUD module, and in turn the final project. I could expand upon the currect project and add or remove animals for the database, update entries, and provide more functionality to the program. This wouldn't be very hard, as the code I wrote would allow for more operations than the final project ultimately used.

How do you approach a problem as a computer scientist? Consider how you approached the database or dashboard requirements that Grazioso Salvare requested. How did your approach to this project differ from previous assignments in other courses? What techniques or strategies would you use in the future to create databases to meet other client requests?

Within this projeect, I used many different APIs. Starting with MongoDB, learning the way the database worked and applying that functionality with Pythod and eventually the Dash framwork was a hard task. Not only did I need to understand each of these components, I also needed to make them work together. I found the best way to come at this project was to work in small pieces. Getting the code to work in smaller chunks helped me move slowly but surely foward. I think this approach to programming is the best for me and provides small stepping stones mvoing forward, where my mistakes can be addressed along the way. I also found that doing more research on how the system worked before starting was nessesary. Learning MongoDB from a research perspective before starting to code helped me not waste time in my overall project.
